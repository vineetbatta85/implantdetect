          ...
          {result && (
            <div className="space-y-6">
              ...
              <p className="text-sm text-gray-400 mt-6">
                Note: This AI prediction assists in knee implant identification. Final verification should be performed by qualified medical professionals.
              </p>
            </div>
          )}
        </div>
