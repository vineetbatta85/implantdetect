...
knee_model = tf.keras.models.load_model("KNEE41ac98_inceptv3.h5")
KNEE_CLASS_LABELS = [
    # Replace with actual labels for the knee model
    "Zimmer NexGen", "Smith & Nephew Genesis II", "Stryker Triathlon", "Depuy Sigma", "Biomet Vanguard"
]
